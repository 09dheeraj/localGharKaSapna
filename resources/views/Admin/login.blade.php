    ...
    <div class="wrapper ovh">
        ...
        <div class="body_content">
            ...
            <section class="our-compare pt60 pb60">
                <img src="{{asset('assets/images/icon/login-page-icon.svg')}}" alt="" class="login-bg-icon wow fadeInLeft" data-wow-delay="300ms">
                <div class="container">
                    <div class="row wow fadeInRight" data-wow-delay="300ms">
                        <div class="col-lg-6">
                            <div class="log-reg-form signup-modal form-style1 bgc-white p50 p30-sm default-box-shadow2 bdrs12">
                                ...
                                <p class=" text-center mb0 mt10">Not signed up? <a class=" fw600" href="page-register.html">Create an account.</a></p>
                            </div>
                        </div>
                    </div>
                </div>
