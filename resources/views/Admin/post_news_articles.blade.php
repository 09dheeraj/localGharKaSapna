...
<div class="container mt-5">
    <h2>Submit Your News & Articles</h2>
    ...
    @endif
    <form action="{{route('submit.articles')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card form-container">
            <div class="card-body">
                ...
                <div class="form-group row align-items-center pt-4 pb-3">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" rows="3" name="title" placeholder="Title Name" required></textarea>
                ...
                <div class="form-group row align-items-center py-3">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" rows="3" name="meta_title" placeholder="Meta Title" required></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row align-items-center py-3">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" rows="3" name="meta_description" placeholder="Meta Description" required></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row align-items-center py-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="meta_keywords" class="form-control form-control-lg" placeholder="Meta Keywords" required>
                    </div>
                </div>
                ...
                <div class="form-group row align-items-center py-3">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" rows="3" name="tick_title" placeholder="Tick title" required></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row align-items-center py-3">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control form-control-lg" rows="3" name="excerpt" placeholder="Short summary or tick description" required></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row align-items-center py-3">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control form-control-lg" rows="3" name="short_description" placeholder="Short description of the article" required></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row align-items-center py-3">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control form-control-lg" rows="5" name="content" placeholder="Full content of the article" required></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row align-items-center py-3">
                    ...
                    <div class="col-md-9">
                        <input class="form-control form-control-lg" id="feature-img" name="featured_image" type="file" required>
                ...
                <div class="form-group row align-items-center py-3">
                    <div class="col-md-12 text-right">
                        <button type="submit" class="ud-btn btn-thm">Save Article</button>
                    </div>
                </div>
