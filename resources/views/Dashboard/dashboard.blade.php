...
<div class="col-lg-6 success-mesg">
    <div class="ui-content">
        <div class="message-alart-style1">
            <div class="alert alart_style_four alert-dismissible fade show mb20" role="alert">{{ session('success') }}
...
<div class="row">
    <div class="col-sm-6 col-xxl-3">
        <div class="d-flex justify-content-between statistics_funfact">
            <div class="details">
                <div class="text fz25">All Post Properties</div>
                <div class="title">{{$countAllPostProperties ? $countAllPostProperties : '0'}}</div>
            </div>
    ...
    <div class="col-sm-6 col-xxl-3">
        <div class="d-flex justify-content-between statistics_funfact">
            <div class="details">
                <div class="text fz25">My Post Properties</div>
                <div class="title">{{$countMyPostProperty ? $countMyPostProperty : '0'}}</div>
            </div>
            <div class="icon text-center"><i class="flaticon-home"></i></div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-xxl-3">
        <div class="d-flex justify-content-between statistics_funfact">
            <div class="details">
                ...
                <div class="title">{{$countVisitorReviews ? $countVisitorReviews : '0'}}</div>
            </div>
            <div class="icon text-center"><i class="flaticon-home"></i></div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-xxl-3">
        <div class="d-flex justify-content-between statistics_funfact">
            <div class="details">
                <div class="text fz25">Total Visitor Likes</div>
                <div class="title">{{$visitorLikes ? $visitorLikes : '0'}}</div>
            </div>
        ...
        <a href="{{route('users')}}">
            <div class="d-flex justify-content-between statistics_funfact">
                <div class="details">
                    ...
                    <div class="title">{{$countUsers ? $countUsers : '0'}}</div>
                </div>
    ...
    <div class="col-sm-6 col-xxl-3">
        <a href="{{route('property.owner')}}">
            <div class="d-flex justify-content-between statistics_funfact">
                <div class="details">
                    <div class="text fz25">Total Properties Owners</div>
                    <div class="title">{{$countVendors ? $countVendors : '0'}}</div>
                </div>
