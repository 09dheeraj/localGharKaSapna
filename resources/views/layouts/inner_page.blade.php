                        ...
                        <div class="col-6 col-lg-auto">
                            <div class="text-center text-lg-start d-flex align-items-center">
                                <div class="dashboard_header_logo position-relative me-2 me-xl-5">
                                    <a href="{{route('index')}}" class="logo"><img src="{{ asset('assets/images/header-logo.png')}}" alt=""></a>
                                </div>
                                <div class="fz20 ms-2 ms-xl-5">
                                    <a href="#" class="dashboard_sidebar_toggle_icon text-thm1 vam"><img src="{{ asset('assets/images/dark-nav-icon.svg')}}" alt=""></a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <div class="user_setting_content">
                                                    ...
                                                    <a class="dropdown-item {{ ($title == 'Welcome to Your Dashboard - Manage Your Activities & Insights' || request()->segment(1) == 'user' || request()->segment(1) == 'property-owner') ? 'active' : ''}}" href="{{route('welcome.dashboard')}}"><i class="flaticon-discovery mr10"></i>Dashboard</a>
                                                    ...
                                                    <a class="dropdown-item {{ $title == 'Manage All Posted Properties - Ghar Ka Sapna Admin' ? 'active' : ''}}" href="{{route('manage.allProperties')}}"><i class="flaticon-home mr10"></i>All Properties</a>
                                                    <a class="dropdown-item {{$title == 'All Posted Properties - Ghar Ka Sapna Admin' ? 'active' : ''}}" href="{{route('admin.postProperty')}}"><i class="flaticon-home mr10"></i>My Properties</a>
                                                    ...
                                                    <a class="dropdown-item {{ ($title == 'Manage News and Articles - Ghar Ka Sapna Admin' || $title == 'Submit Your News & Articles - Ghar Ka Sapna Admin' || request()->segment(1) == 'edit-article' || request()->segment(1) == 'article') ? 'active' : ''}}" href="{{route('manage.news.articles')}}"><i class="flaticon-search-2 mr10"></i>News & Articles</a>
                                                    <a class="dropdown-item {{ $title == 'Profile Overview - Ghar Ka Sapna' ? 'active' : ''}}" href="{{route('profile')}}"><i class="flaticon-user mr10"></i>My Profile</a>
                                                    <a class="dropdown-item" href="{{route('logout')}}"><i class="flaticon-exit mr10"></i>Logout</a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="text-center text-lg-end header_right_widgets">
                                <ul class="mb0 d-flex justify-content-center justify-content-sm-end p-0">
                                    <li class=" user_setting">
                                        <div class="dropdown">
                                            <a class="btn" href="#" data-bs-toggle="dropdown">
                                                <img src="{{ asset('assets/profileImg/' . session()->get('image')) }}" alt="user.png">
                                            </a>
                                            <div class="dropdown-menu">
                                                <div class="user_setting_content">
                                                    <p class="fz15 fw400 ff-heading mb20">MAIN</p>
                                                    <a class="dropdown-item {{ $title == 'Welcome to Your Dashboard - Manage Your Activities & Insights' ? 'active' : ''}}" href="{{route('welcome.dashboard')}}"><i class="flaticon-discovery mr10"></i>Dashboard</a>
                                                    <!-- <a class="dropdown-item" href="page-dashboard-message.html"><i class="flaticon-chat-1 mr10"></i>Message</a> -->
                                                    <p class="fz15 fw400 ff-heading mt30">MANAGE LISTINGS</p>
                                                    <a class="dropdown-item" href="{{route('post.property')}}"><i class="flaticon-new-tab mr10"></i>Add New Property</a>
                                                    <a class="dropdown-item {{ ($title == 'My Post Properties - Ghar Ka Sapna' || request()->segment(1) == 'edit-post' || request()->segment(1) == 'single' ) ? 'active' : ''}}" href="{{route('my.postProperty')}}"><i class="flaticon-home mr10"></i>My Properties</a>
                                                    <!-- <a class="dropdown-item" href="page-dashboard-favorites.html"><i class="flaticon-like mr10"></i>My Favorites</a>
                                                    <a class="dropdown-item" href="page-dashboard-savesearch.html"><i class="flaticon-search-2 mr10"></i>Saved Search</a>
                                                    <a class="dropdown-item" href="page-dashboard-review.html"><i class="flaticon-review mr10"></i>Reviews</a>
                                                    <p class="fz15 fw400 ff-heading mt30">MANAGE ACCOUNT</p>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <div class="user_setting_content">
                                                    ...
                                                    <a class="dropdown-item" href="page-dashboard-order.html"><i class="flaticon-home mr10"></i>My Properties</a>
                                                    <a class="dropdown-item" href="page-dashboard-favorites.html"><i class="flaticon-like mr10"></i>My Favorites</a>
                                                    <a class="dropdown-item" href="page-dashboard-savesearch.html"><i class="flaticon-search-2 mr10"></i>Saved Search</a>
                                                    <a class="dropdown-item" href="page-dashboard-review.html"><i class="flaticon-review mr10"></i>Reviews</a> -->
                                                    <p class="fz15 fw400 ff-heading mt30">MANAGE ACCOUNT</p>
                ...
                <div class="header innerpage-style">
                    <div class="menu_and_widgets">
                        <div class="mobile_menu_bar d-flex justify-content-between align-items-center">
                            ...
                            <a class="mobile_logo" href="#"><img src="{{ asset('assets/images/header-logo2.svg')}}" alt=""></a>
                ...
                <div class="dashboard__sidebar d-none d-lg-block">
                    <div class="dashboard_sidebar_list">
                        <div class="sidebar_list_item">
                            <a href="{{route('welcome.dashboard')}}" class="items-center -is-{{ ($title == 'Welcome to Your Dashboard - Manage Your Activities & Insights' || request()->segment(1) == 'user' || request()->segment(1) == 'property-owner') ? 'active' : ''}}"><i class="flaticon-discovery mr15"></i>Dashboard</a>
                        </div>
                        <!-- <div class="sidebar_list_item ">
                        ...
                        <div class="sidebar_list_item ">
                            <a href="{{route('manage.allProperties')}}" class="items-center -is-{{ $title == 'Manage All Posted Properties - Ghar Ka Sapna Admin' ? 'active' : ''}}"><i class="flaticon-home mr15"></i>All Properties</a>
                        </div>
                        <div class="sidebar_list_item ">
                            <a href="{{route('admin.postProperty')}}" class="items-center -is-{{$title == 'All Posted Properties - Ghar Ka Sapna Admin' ? 'active' : ''}}"><i class="flaticon-home mr10"></i>My Properties</a>
                        </div>
                        ...
                        <div class="sidebar_list_item ">
                            <a href="{{route('manage.news.articles')}}" class="items-center -is-{{ ($title == 'Manage News and Articles - Ghar Ka Sapna Admin' || $title == 'Submit Your News & Articles - Ghar Ka Sapna Admin' || request()->segment(1) == 'edit-article' || request()->segment(1) == 'article') ? 'active' : ''}}"><i class="flaticon-search-2 mr15"></i>News & Articles</a>
                        </div>
                        <div class="sidebar_list_item ">
                            <a href="{{route('profile')}}" class="items-center -is-{{ $title == 'Profile Overview - Ghar Ka Sapna' ? 'active' : ''}}"><i class="flaticon-user mr15"></i>My Profile</a>
                        </div>
                        <div class="sidebar_list_item ">
                    ...
                    <div class="dashboard__content bgc-f7">
                        <div class="row pb40">
                                ...
                                <div class="dashboard_navigationbar d-block d-lg-none">
                                    <div class="dropdown">
                                        ...
                                        <ul id="myDropdown" class="dropdown-content">
                                            <li class="{{ ($title == 'Welcome to Your Dashboard - Manage Your Activities & Insights' || request()->segment(1) == 'user'  ) ? 'active' : ''}}"><a href="{{route('welcome.dashboard')}}"><i class="flaticon-discovery mr10"></i>Dashboard</a></li>
                                            ...
                                            <li class="{{ $title == 'Manage All Posted Properties - Ghar Ka Sapna Admin' ? 'active' : ''}}"><a href="{{route('manage.allProperties')}}"><i class="flaticon-home mr10"></i>All Properties</a></li>
                                            <li class="{{$title == 'All Posted Properties - Ghar Ka Sapna Admin' ? 'active' : ''}}"><a href="{{route('admin.postProperty')}}"><i class="flaticon-home mr10"></i>My Properties</a></li>
                                            ...
                                            <li class="{{ ($title == 'Manage News and Articles - Ghar Ka Sapna Admin' || $title == 'Submit Your News & Articles - Ghar Ka Sapna Admin' || request()->segment(1) == 'edit-article' || request()->segment(1) == 'article') ? 'active' : ''}}"><a href="{{route('manage.news.articles')}}"><i class="flaticon-search-2 mr10"></i>News & Articles</a></li>
                                            <!-- <li><a href="page-dashboard-package.html"><i class="flaticon-protection mr10"></i>My Package</a></li> -->
                                            <li class="{{ $title == 'Profile Overview - Ghar Ka Sapna' ? 'active' : ''}}"><a href="{{route('profile')}}"><i class="flaticon-user mr10"></i>My Profile</a></li>
                            ...
                            <div class="dashboard__sidebar d-none d-lg-block">
                                <div class="dashboard_sidebar_list">
                                    <div class="sidebar_list_item">
                                        <a href="{{route('welcome.dashboard')}}" class="items-center -is-{{ $title == 'Welcome to Your Dashboard - Manage Your Activities & Insights' ? 'active' : ''}}"><i class="flaticon-discovery mr15"></i>Dashboard</a>
                                    </div>
                                    <!-- <div class="sidebar_list_item ">
                                        <a href="page-dashboard-message.html" class="items-center"><i class="flaticon-chat-1 mr15"></i>Message</a>
                                    </div> -->
                                    ...
                                    <div class="sidebar_list_item ">
                                        <a href="{{route('my.postProperty')}}" class="items-center -is-{{ ($title == 'My Post Properties - Ghar Ka Sapna' || request()->segment(1) == 'edit-post' ||  request()->segment(1) == 'single') ? 'active' : ''}}"><i class="flaticon-home mr15"></i>My Properties</a>
                                    </div>
                                    <!-- <div class="sidebar_list_item ">
                                        <a href="page-dashboard-favorites.html" class="items-center"><i class="flaticon-like mr15"></i>My Favorites</a>
                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="dashboard_navigationbar d-block d-lg-none">
                                                <div class="dropdown">
                                                    <button onclick="myFunction()" class="dropbtn"><i class="fa fa-bars pr10"></i> Dashboard Navigation</button>
                                                    <ul id="myDropdown" class="dropdown-content">
                                                        <li class="{{ $title == 'Welcome to Your Dashboard - Manage Your Activities & Insights' ? 'active' : ''}}"><a href="{{route('welcome.dashboard')}}"><i class="flaticon-discovery mr10"></i>Dashboard</a></li>
                                                        <!-- <li><a href="page-dashboard-message.html"><i class="flaticon-chat-1 mr10"></i>Message</a></li> -->
                                                        <li>
                                                            <p class="fz15 fw400 ff-heading mt30 pl30">MANAGE LISTINGS</p>
                                                        </li>
                                                        <li><a href="{{route('post.property')}}"><i class="flaticon-new-tab mr10"></i>Add New Property</a></li>
                                                        <li class="{{ ($title == 'My Post Properties - Ghar Ka Sapna'  || request()->segment(1) == 'edit-post' || request()->segment(1) == 'single') ? 'active' : ''}}"><a href="{{route('my.postProperty')}}"><i class="flaticon-home mr10"></i>My Properties</a></li>
                                                        <!-- <li><a href="page-dashboard-favorites.html"><i class="flaticon-like mr10"></i>My Favorites</a></li>
                                                        <li><a href="page-dashboard-savesearch.html"><i class="flaticon-search-2 mr10"></i>Saved Search</a></li>
                                                        <li><a href="page-dashboard-review.html"><i class="flaticon-review mr10"></i>Reviews</a></li>
                                                        <li>
